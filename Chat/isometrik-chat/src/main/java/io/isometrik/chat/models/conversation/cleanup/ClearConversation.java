...
/**
 * The helper class to validate request params and make the clear conversation request and expose the parsed successful or error response.
 */
public class ClearConversation {
   ...
   * @param gson the gson
   */
  public void validateParams(@NotNull ClearConversationQuery clearConversationQuery,
      @NotNull final CompletionHandler<ClearConversationResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {

    String conversationId = clearConversationQuery.getConversationId();
    String userToken = clearConversationQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<ClearConversationResult> call =
          retrofitManager.getConversationService().clearConversation(headers, queryParams);

      call.enqueue(new Callback<ClearConversationResult>() {
        @Override
        public void onResponse(@NotNull Call<ClearConversationResult> call,
            @NotNull Response<ClearConversationResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<ClearConversationResult> call, @NotNull Throwable t) {
