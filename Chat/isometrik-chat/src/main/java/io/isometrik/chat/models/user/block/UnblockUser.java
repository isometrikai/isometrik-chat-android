...
/**
 * The helper class to validate request params and make the unblock user request and expose the parsed successful or error response.
 */
public class UnblockUser {
   ...
   * @param gson the gson
   */
  public void validateParams(@NotNull UnblockUserQuery unblockUserQuery,
      @NotNull final CompletionHandler<UnblockUserResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {
    String opponentId = unblockUserQuery.getOpponentId();
    String userToken = unblockUserQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<UnblockUserResult> call =
          retrofitManager.getUserService().unblockUser(headers, bodyParams);

      call.enqueue(new Callback<UnblockUserResult>() {
        @Override
        public void onResponse(@NotNull Call<UnblockUserResult> call,
            @NotNull Response<UnblockUserResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<UnblockUserResult> call, @NotNull Throwable t) {
