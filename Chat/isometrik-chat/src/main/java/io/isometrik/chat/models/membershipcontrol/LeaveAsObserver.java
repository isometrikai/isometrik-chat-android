...
/**
 * The helper class to validate request params and make the leave as observer request and expose the parsed successful or error response.
 */
public class LeaveAsObserver {
  /**
   * Validate params.
   *
   ...
   * @param gson the gson
   */
  public void validateParams(@NotNull LeaveAsObserverQuery leaveAsObserverQuery,
      @NotNull final CompletionHandler<LeaveAsObserverResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {
    String conversationId = leaveAsObserverQuery.getConversationId();
    String userToken = leaveAsObserverQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<LeaveAsObserverResult> call =
          retrofitManager.getMembershipControlService().leaveAsObserver(headers, queryParams);

      call.enqueue(new Callback<LeaveAsObserverResult>() {
        @Override
        public void onResponse(@NotNull Call<LeaveAsObserverResult> call,
            @NotNull Response<LeaveAsObserverResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<LeaveAsObserverResult> call, @NotNull Throwable t) {
