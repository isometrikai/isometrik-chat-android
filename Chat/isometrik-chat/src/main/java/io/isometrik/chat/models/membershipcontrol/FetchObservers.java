...
/**
 * The helper class to validate request params and make the fetch observers request and expose the parsed successful or error response.
 */
public class FetchObservers {
  /**
   * Validate params.
   *
   ...
   * @param gson the gson
   */
  public void validateParams(@NotNull FetchObserversQuery fetchObserversQuery,
      @NotNull final CompletionHandler<FetchObserversResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {

    String conversationId = fetchObserversQuery.getConversationId();
    Integer skip = fetchObserversQuery.getSkip();
    Integer limit = fetchObserversQuery.getLimit();
    String userToken = fetchObserversQuery.getUserToken();
    String searchTag = fetchObserversQuery.getSearchTag();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<FetchObserversResult> call =
          retrofitManager.getMembershipControlService().fetchObservers(headers, queryParams);

      call.enqueue(new Callback<FetchObserversResult>() {
        @Override
        public void onResponse(@NotNull Call<FetchObserversResult> call,
            @NotNull Response<FetchObserversResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<FetchObserversResult> call, @NotNull Throwable t) {
