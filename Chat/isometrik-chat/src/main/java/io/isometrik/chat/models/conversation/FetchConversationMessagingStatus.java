...
/**
 * The helper class to validate request params and make the fetch conversation messaging status request and expose the parsed successful or error response.
 */
public class FetchConversationMessagingStatus {
  /**
   * Validate params.
   *
  ...
  public void validateParams(
      ...
      @NotNull final CompletionHandler<FetchConversationMessagingStatusResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {

    String conversationId = fetchConversationMessagingStatusQuery.getConversationId();
    String userToken = fetchConversationMessagingStatusQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<FetchConversationMessagingStatusResult> call = retrofitManager.getConversationService()
          .fetchConversationMessagingStatus(headers, queryParams);

      call.enqueue(new Callback<FetchConversationMessagingStatusResult>() {
        @Override
        public void onResponse(@NotNull Call<FetchConversationMessagingStatusResult> call,
            @NotNull Response<FetchConversationMessagingStatusResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<FetchConversationMessagingStatusResult> call,
            @NotNull Throwable t) {
