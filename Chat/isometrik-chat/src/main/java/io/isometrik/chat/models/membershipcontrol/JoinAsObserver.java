...
/**
 * The helper class to validate request params and make the join as observer request and expose the parsed successful or error response.
 */
public class JoinAsObserver {
  /**
   * Validate params.
   *
   ...
   * @param gson the gson
   */
  public void validateParams(@NotNull JoinAsObserverQuery joinAsObserverQuery,
      @NotNull final CompletionHandler<JoinAsObserverResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {
    String conversationId = joinAsObserverQuery.getConversationId();
    String userToken = joinAsObserverQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<JoinAsObserverResult> call =
          retrofitManager.getMembershipControlService().joinAsObserver(headers, bodyParams);

      call.enqueue(new Callback<JoinAsObserverResult>() {
        @Override
        public void onResponse(@NotNull Call<JoinAsObserverResult> call,
            @NotNull Response<JoinAsObserverResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<JoinAsObserverResult> call, @NotNull Throwable t) {
