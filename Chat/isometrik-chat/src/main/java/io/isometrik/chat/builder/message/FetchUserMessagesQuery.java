...
/**
 * The query builder for fetching user messages request.
 */
public class FetchUserMessagesQuery {
  ...
  private final Boolean fetchConversationDetails;
  private final Boolean deliveredToMe;
  private final Boolean senderIdsExclusive;
  private final boolean markMessageAsDelivered;

  private FetchUserMessagesQuery(Builder builder) {
    ...
    this.fetchConversationDetails = builder.fetchConversationDetails;
    this.deliveredToMe = builder.deliveredToMe;
    this.senderIdsExclusive = builder.senderIdsExclusive;
    this.markMessageAsDelivered = builder.markMessageAsDelivered;
  }

  /**
   * The builder class for building fetch user messages query.
   */
  public static class Builder {
    ...
    private Boolean fetchConversationDetails;
    private Boolean deliveredToMe;
    private Boolean senderIdsExclusive;
    private boolean markMessageAsDelivered;
    ...
    /**
     * Sets fetch conversation details.
     *
     * @param fetchConversationDetails the fetch conversation details
     * @return the fetch conversation details
     */
    public Builder setFetchConversationDetails(Boolean fetchConversationDetails) {
      this.fetchConversationDetails = fetchConversationDetails;
      return this;
    }
    ...
    /**
     * Sets mark message as delivered.
     *
     * @param markMessageAsDelivered the mark message as delivered
     * @return the mark message as delivered
     */
    public Builder setMarkMessageAsDelivered(boolean markMessageAsDelivered) {
      this.markMessageAsDelivered = markMessageAsDelivered;
      return this;
    }

    /**
     * Build fetch user messages query.
     *
     * @return the fetch user messages query
     */
    public FetchUserMessagesQuery build() {
      return new FetchUserMessagesQuery(this);
    }
  }

  /**
   * Gets fetch conversation details.
   *
   * @return the fetch conversation details
   */
  public Boolean getFetchConversationDetails() {
  ...
  /**
   * Is mark message as delivered boolean.
   *
   * @return the boolean
   */
  public boolean isMarkMessageAsDelivered() {
    return markMessageAsDelivered;
  }
}
