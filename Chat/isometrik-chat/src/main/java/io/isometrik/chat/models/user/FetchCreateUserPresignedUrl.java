...
/**
 * The helper class to validate request params and make the fetch create user presigned url request and expose the parsed successful or error response.
 */
public class FetchCreateUserPresignedUrl {
   ...
   * @param gson the gson
   */
  public void validateParams(@NotNull FetchCreateUserPresignedUrlQuery fetchCreateUserPresignedUrlQuery,
      @NotNull final CompletionHandler<FetchCreateUserPresignedUrlResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {

    String userIdentifier = fetchCreateUserPresignedUrlQuery.getUserIdentifier();
    String mediaExtension = fetchCreateUserPresignedUrlQuery.getMediaExtension();
    ...
    if (userIdentifier == null || userIdentifier.isEmpty()) {
      ...
      Call<FetchCreateUserPresignedUrlResult> call =
          retrofitManager.getUserService().fetchCreateUserPresignedUrl(headers, queryParams);

      call.enqueue(new Callback<FetchCreateUserPresignedUrlResult>() {
        @Override
        public void onResponse(@NotNull Call<FetchCreateUserPresignedUrlResult> call,
            @NotNull Response<FetchCreateUserPresignedUrlResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<FetchCreateUserPresignedUrlResult> call,
            @NotNull Throwable t) {
