package io.isometrik.chat.models.message.delivery;
...
/**
 * The helper class to validate request params and make the update last read in conversation request and expose the parsed successful or error response.
 */
public class UpdateLastReadInConversation {
  /**
   * Validate params.
   *
  ...
  public void validateParams(
      ...
      @NotNull final CompletionHandler<UpdateLastReadInConversationResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {
    String conversationId = updateLastReadInConversationQuery.getConversationId();
    String userToken = updateLastReadInConversationQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      if(updateLastReadInConversationQuery.getTimestamp()!=null) {
        bodyParams.put("timestamp", updateLastReadInConversationQuery.getTimestamp());
      }
      Call<UpdateLastReadInConversationResult> call =
          retrofitManager.getMessageService().updateLastReadInConversation(headers, bodyParams);

      call.enqueue(new Callback<UpdateLastReadInConversationResult>() {
        @Override
        public void onResponse(@NotNull Call<UpdateLastReadInConversationResult> call,
            @NotNull Response<UpdateLastReadInConversationResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<UpdateLastReadInConversationResult> call,
            @NotNull Throwable t) {
