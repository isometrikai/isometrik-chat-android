...
/**
 * The helper class to validate request params and make the fetch conversation watchers request and expose the parsed successful or error response.
 */
public class FetchConversationWatchers {
  /**
   * Validate params.
   *
   ...
   * @param gson the gson
   */
  public void validateParams(@NotNull FetchConversationWatchersQuery fetchConversationWatchersQuery,
      @NotNull final CompletionHandler<FetchConversationWatchersResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {

    String conversationId = fetchConversationWatchersQuery.getConversationId();
    Integer limit = fetchConversationWatchersQuery.getLimit();
    Integer skip = fetchConversationWatchersQuery.getSkip();
    String userToken = fetchConversationWatchersQuery.getUserToken();
    String searchTag = fetchConversationWatchersQuery.getSearchTag();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<FetchConversationWatchersResult> call =
          retrofitManager.getConversationService().fetchConversationWatchers(headers, queryParams);

      call.enqueue(new Callback<FetchConversationWatchersResult>() {
        @Override
        public void onResponse(@NotNull Call<FetchConversationWatchersResult> call,
            @NotNull Response<FetchConversationWatchersResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<FetchConversationWatchersResult> call,
            @NotNull Throwable t) {
