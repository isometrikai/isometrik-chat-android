...
/**
 * The helper class to validate request params and make the mark message as delivered request and expose the parsed successful or error response.
 */
public class MarkMessageAsDelivered {
  /**
   * Validate params.
   *
   ...
   * @param gson the gson
   */
  public void validateParams(@NotNull MarkMessageAsDeliveredQuery markMessageAsDeliveredQuery,
      @NotNull final CompletionHandler<MarkMessageAsDeliveredResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {
    String conversationId = markMessageAsDeliveredQuery.getConversationId();
    String messageId = markMessageAsDeliveredQuery.getMessageId();
    String userToken = markMessageAsDeliveredQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<MarkMessageAsDeliveredResult> call =
          retrofitManager.getMessageService().markMessageAsDelivered(headers, bodyParams);

      call.enqueue(new Callback<MarkMessageAsDeliveredResult>() {
        @Override
        public void onResponse(@NotNull Call<MarkMessageAsDeliveredResult> call,
            @NotNull Response<MarkMessageAsDeliveredResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<MarkMessageAsDeliveredResult> call,
            @NotNull Throwable t) {
