...
/**
 * The helper class to validate request params and make the fetch message pending delivery status request and expose the parsed successful or error response.
 */
public class FetchMessagePendingDeliveryStatus {
  /**
   * Validate params.
   *
  ...
  public void validateParams(
      ...
      @NotNull final CompletionHandler<FetchMessagePendingDeliveryStatusResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {

    String conversationId = fetchMessagePendingDeliveryStatusQuery.getConversationId();
    String messageId = fetchMessagePendingDeliveryStatusQuery.getMessageId();
    Integer limit = fetchMessagePendingDeliveryStatusQuery.getLimit();
    Integer skip = fetchMessagePendingDeliveryStatusQuery.getSkip();
    String userToken = fetchMessagePendingDeliveryStatusQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<FetchMessagePendingDeliveryStatusResult> call =
          retrofitManager.getDeliveryStatusService()
              .fetchMessagePendingDeliveryStatus(headers, queryParams);

      call.enqueue(new Callback<FetchMessagePendingDeliveryStatusResult>() {
        @Override
        public void onResponse(@NotNull Call<FetchMessagePendingDeliveryStatusResult> call,
            @NotNull Response<FetchMessagePendingDeliveryStatusResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<FetchMessagePendingDeliveryStatusResult> call,
            @NotNull Throwable t) {
