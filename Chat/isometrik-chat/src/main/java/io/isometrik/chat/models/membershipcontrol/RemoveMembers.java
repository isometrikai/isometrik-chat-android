package io.isometrik.chat.models.membershipcontrol;
...
/**
 * The helper class to validate request params and make the remove members request and expose the parsed successful or error response.
 */
public class RemoveMembers {
   ...
   * @param gson the gson
   */
  public void validateParams(@NotNull RemoveMembersQuery removeMembersQuery,
      @NotNull final CompletionHandler<RemoveMembersResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {
    String conversationId = removeMembersQuery.getConversationId();
    List<String> members = removeMembersQuery.getMembers();
    String userToken = removeMembersQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      completionHandler.onComplete(null, IsometrikErrorBuilder.IMERROBJ_MEMBERIDS_MISSING);
    } else {
      ...
      queryParams.put("members", MapUtils.stringListToCsv(members));

      Call<RemoveMembersResult> call =
          retrofitManager.getMembershipControlService().removeMembers(headers, queryParams);

      call.enqueue(new Callback<RemoveMembersResult>() {
        @Override
        public void onResponse(@NotNull Call<RemoveMembersResult> call,
            @NotNull Response<RemoveMembersResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<RemoveMembersResult> call, @NotNull Throwable t) {
