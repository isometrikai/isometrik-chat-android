package io.isometrik.chat.models.conversation.cleanup;
...
/**
 * The helper class to validate request params and make the delete conversation locally request and expose the parsed successful or error response.
 */
public class DeleteConversationLocally {
   ...
   * @param gson the gson
   */
  public void validateParams(@NotNull DeleteConversationLocallyQuery deleteConversationLocallyQuery,
      @NotNull final CompletionHandler<DeleteConversationLocallyResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {

    String conversationId = deleteConversationLocallyQuery.getConversationId();
    String userToken = deleteConversationLocallyQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<DeleteConversationLocallyResult> call =
          retrofitManager.getConversationService().deleteConversationLocally(headers, queryParams);

      call.enqueue(new Callback<DeleteConversationLocallyResult>() {
        @Override
        public void onResponse(@NotNull Call<DeleteConversationLocallyResult> call,
            @NotNull Response<DeleteConversationLocallyResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<DeleteConversationLocallyResult> call,
            @NotNull Throwable t) {
