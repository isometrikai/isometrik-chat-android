...
/**
 * The helper class to validate request params and make the fetch reactions request and expose the parsed successful or error response.
 */
public class FetchReactions {
  /**
   * Validate params.
   *
   ...
   * @param gson the gson
   */
  public void validateParams(@NotNull FetchReactionsQuery fetchReactionsQuery,
      @NotNull final CompletionHandler<FetchReactionsResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {
    String reactionType = fetchReactionsQuery.getReactionType();
    String conversationId = fetchReactionsQuery.getConversationId();
    String messageId = fetchReactionsQuery.getMessageId();
    Integer skip = fetchReactionsQuery.getSkip();
    Integer limit = fetchReactionsQuery.getLimit();
    String userToken = fetchReactionsQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<FetchReactionsResult> call =
          retrofitManager.getReactionService().fetchReactions(headers, reactionType, queryParams);

      call.enqueue(new Callback<FetchReactionsResult>() {
        @Override
        public void onResponse(@NotNull Call<FetchReactionsResult> call,
            @NotNull Response<FetchReactionsResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<FetchReactionsResult> call, @NotNull Throwable t) {
