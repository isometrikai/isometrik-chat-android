...
/**
 * The helper class to validate request params and make the join conversation request and expose the parsed successful or error response.
 */
public class JoinConversation {
   ...
   * @param gson the gson
   */
  public void validateParams(@NotNull JoinConversationQuery joinConversationQuery,
      @NotNull final CompletionHandler<JoinConversationResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {
    String conversationId = joinConversationQuery.getConversationId();
    String userToken = joinConversationQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<JoinConversationResult> call =
          retrofitManager.getMembershipControlService().joinConversation(headers, bodyParams);

      call.enqueue(new Callback<JoinConversationResult>() {
        @Override
        public void onResponse(@NotNull Call<JoinConversationResult> call,
            @NotNull Response<JoinConversationResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<JoinConversationResult> call, @NotNull Throwable t) {
