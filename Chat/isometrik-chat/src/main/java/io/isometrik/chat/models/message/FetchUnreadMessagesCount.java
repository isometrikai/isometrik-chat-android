...
/**
 * The helper class to validate request params and make the fetch unread messages count request and expose the parsed successful or error response.
 */
public class FetchUnreadMessagesCount {
  /**
   * Validate params.
   *
   ...
   * @param gson the gson
   */
  public void validateParams(@NotNull FetchUnreadMessagesCountQuery fetchUnreadMessagesCountQuery,
      @NotNull final CompletionHandler<FetchUnreadMessagesCountResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {
    String conversationId = fetchUnreadMessagesCountQuery.getConversationId();
    String userToken = fetchUnreadMessagesCountQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<FetchUnreadMessagesCountResult> call =
          retrofitManager.getMessageService().fetchUnreadMessagesCount(headers, queryParams);

      call.enqueue(new Callback<FetchUnreadMessagesCountResult>() {
        @Override
        public void onResponse(@NotNull Call<FetchUnreadMessagesCountResult> call,
            @NotNull Response<FetchUnreadMessagesCountResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<FetchUnreadMessagesCountResult> call,
            @NotNull Throwable t) {
