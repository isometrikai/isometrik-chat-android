...
public interface CreateUserContract {
  ...
  interface Presenter {
     ...
     * @param userPassword the user password of the user to be created
     * @param userMetadata the user metadata of the user to be created
     */
     ...
     * @param userPassword the user password to be validated locally
     * @param file the file containing user image to be validated locally
     */
    void validateUserDetails(String userName, String userIdentifier, String userPassword,
        File file);
     ...
     */
    void requestImageUpload(String requestId, String userIdentifier, String mediaPath);
