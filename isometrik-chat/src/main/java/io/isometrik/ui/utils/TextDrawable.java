...
/**
 * Helper class to show the first letter of name.
 */
public class TextDrawable extends ShapeDrawable {
  ...
  private int getDarkerShade(int color) {
    return Color.rgb((int) (SHADE_FACTOR * Color.red(color)),
        (int) (SHADE_FACTOR * Color.green(color)), (int) (SHADE_FACTOR * Color.blue(color)));
  }
  ...
  /**
   * The interface Config builder.
   */
  public interface IConfigBuilder {
    /**
     * Width config builder.
     *
  ...
  /**
   * The interface Shape builder.
   */
  public interface IShapeBuilder {

    /**
     * Begin config config builder.
     *
     * @return the config builder
     */
    ...
    /**
     * Build round rect text drawable.
     *
     * @param text the text
     * @param color the color
     * @param radius the radius
