...
import io.isometrik.chat.databinding.IsmReceivedMessageAudioCallBinding
...
class AudioCallReceivedBinder : MessageItemBinder<MessagesModel, IsmReceivedMessageAudioCallBinding> {

    override fun createBinding(parent: ViewGroup, viewType: Int): IsmReceivedMessageAudioCallBinding {
        return IsmReceivedMessageAudioCallBinding.inflate(
    ...
    override fun bindData(
        mContext: Context,
        binding: IsmReceivedMessageAudioCallBinding,
