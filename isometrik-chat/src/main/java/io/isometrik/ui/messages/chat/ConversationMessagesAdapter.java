...
import io.isometrik.ui.messages.chat.viewholders.PostMessageReceivedViewHolder;
import io.isometrik.ui.messages.chat.viewholders.PostMessageSentViewHolder;
...
public class ConversationMessagesAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
  ...
  private static final int POST_MESSAGE_SENT = 23;
  private static final int POST_MESSAGE_RECEIVED = 24;
  ...
  public interface OnScrollToMessageListener {
    void onScrollToParentMessage(String messageId);
  }

  private OnScrollToMessageListener scrollToMessageListener;
  ...
  public ConversationMessagesAdapter(Context mContext, ArrayList<MessagesModel> messages,
                                     ...
                                     boolean joiningAsObserver,OnScrollToMessageListener scrollToMessageListener) {
  ...
  public RecyclerView.ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
    ...
    switch (viewType) {
      ...
      case POST_MESSAGE_SENT:
        //post message sent
        IsmSentMessagePostBinding ismSentMessagePostBinding =
                IsmSentMessagePostBinding.inflate(LayoutInflater.from(viewGroup.getContext()),
                        viewGroup, false);

        return new PostMessageSentViewHolder(ismSentMessagePostBinding);
      ...
      case POST_MESSAGE_RECEIVED:
        ...
        IsmReceivedMessagePostBinding ismReceivedMessagePostBinding =
                IsmReceivedMessagePostBinding.inflate(LayoutInflater.from(viewGroup.getContext()),
                        viewGroup, false);

        return new PostMessageReceivedViewHolder(ismReceivedMessagePostBinding);
  ...
  public void onBindViewHolder(RecyclerView.ViewHolder viewHolder, int position) {
    ...
    switch (viewHolder.getItemViewType()) {
      ...
      case POST_MESSAGE_SENT:
        //Contact message sent
        configurePostMessageSentViewHolder((PostMessageSentViewHolder) viewHolder, position);
        break;
      case POST_MESSAGE_RECEIVED:
        //Contact message sent
        configurePostMessageReceivedViewHolder((PostMessageReceivedViewHolder) viewHolder, position);
        break;
      case TEXT_MESSAGE_RECEIVED:
        //Text message received
        ...
        if (message.isQuotedMessage()) {
          ...
          if (message.getOriginalMessageAttachmentUrl() == null) {
            textMessageSentViewHolder.ismSentMessageTextBinding.vParentMessage.ivMessageImage.setVisibility(
                    View.GONE);
            textMessageSentViewHolder.ismSentMessageTextBinding.vParentMessage.tvMessage.setVisibility(View.VISIBLE);
          } else {
            try {
              Glide.with(mContext)
          ...
          textMessageSentViewHolder.ismSentMessageTextBinding.vParentMessage.getRoot().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
              scrollToMessageListener.onScrollToParentMessage(message.getParentMessageId());
            }
          });
        } else {
          textMessageSentViewHolder.ismSentMessageTextBinding.vParentMessage.getRoot()
    ...
    try {
      ...
      if (message != null) {
        ...
        if (message.isQuotedMessage()) {
          ...
          photoMessageSentViewHolder.ismSentMessagePhotoBinding.vParentMessage.getRoot().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
              scrollToMessageListener.onScrollToParentMessage(message.getParentMessageId());
            }
  ...
  private void configurePostMessageSentViewHolder(
          PostMessageSentViewHolder postMessageSentViewHolder, int position) {
    try {
      MessagesModel message = messages.get(position);
      if (message != null) {
        postMessageSentViewHolder.ismSentMessagePostBinding.ivEdited.setVisibility(
                message.isEditedMessage() ? View.VISIBLE : View.GONE);

        if (message.isReadByAll()) {
          postMessageSentViewHolder.ismSentMessagePostBinding.ivDeliveryReadStatus.setImageDrawable(
                  ContextCompat.getDrawable(mContext, R.drawable.ism_message_read_double_tick));

          postMessageSentViewHolder.ismSentMessagePostBinding.ivDeliveryReadStatus.setVisibility(
                  View.VISIBLE);
        } else if (message.isDeliveredToAll()) {
          postMessageSentViewHolder.ismSentMessagePostBinding.ivDeliveryReadStatus.setImageDrawable(
                  ContextCompat.getDrawable(mContext, R.drawable.ism_message_delivered_doubletick));
        ...
        if (message.isMessageSentSuccessfully()) {
          postMessageSentViewHolder.ismSentMessagePostBinding.tvSendingMessage.setVisibility(
                  View.GONE);
        } else {
          if (message.isSendingMessageFailed()) {
            postMessageSentViewHolder.ismSentMessagePostBinding.tvSendingMessage.setTextColor(
                    ContextCompat.getColor(mContext, R.color.ism_leave_red));
            postMessageSentViewHolder.ismSentMessagePostBinding.tvSendingMessage.setText(
                    mContext.getString(R.string.ism_failed));
          } else {
            postMessageSentViewHolder.ismSentMessagePostBinding.tvSendingMessage.setTextColor(
                    ContextCompat.getColor(mContext, R.color.ism_message_time_grey));
        ...
        if (message.isForwardedMessage()) {
          postMessageSentViewHolder.ismSentMessagePostBinding.vForwardedMessage.getRoot()
                  .setVisibility(View.VISIBLE);

          if (message.getForwardedMessageNotes() == null) {

            postMessageSentViewHolder.ismSentMessagePostBinding.vForwardedMessageNotes.getRoot()
                    .setVisibility(View.GONE);
          } else {
            postMessageSentViewHolder.ismSentMessagePostBinding.vForwardedMessageNotes.tvMessage
                    .setText(message.getForwardedMessageNotes());
        ...
        if (multipleMessagesSelectModeOn) {
          ...
          postMessageSentViewHolder.ismSentMessagePostBinding.ivSelectedStatus.setSelected(
                  message.isSelected());
          postMessageSentViewHolder.ismSentMessagePostBinding.ivSelectedStatus.setVisibility(
                  View.VISIBLE);
          postMessageSentViewHolder.ismSentMessagePostBinding.ivForward.setVisibility(View.GONE);
        } else {

          if (message.isMessageSentSuccessfully()) {
            postMessageSentViewHolder.ismSentMessagePostBinding.ivForward.setVisibility(
                    View.GONE);
            postMessageSentViewHolder.ismSentMessagePostBinding.ivForward.setOnClickListener(
                    v -> conversationMessagesActivity.forwardMessageRequest(message));
          } else {
            postMessageSentViewHolder.ismSentMessagePostBinding.ivForward.setVisibility(
                    View.GONE);
        ...
        if (message.isQuotedMessage()) {
          postMessageSentViewHolder.ismSentMessagePostBinding.vParentMessage.getRoot()
                  .setVisibility(View.VISIBLE);
          postMessageSentViewHolder.ismSentMessagePostBinding.vParentMessage.tvSenderName.setText(
                  message.getOriginalMessageSenderName());
          postMessageSentViewHolder.ismSentMessagePostBinding.vParentMessage.tvMessage.setText(
                  message.getOriginalMessage());
          postMessageSentViewHolder.ismSentMessagePostBinding.vParentMessage.tvMessageTime.setText(
                  TimeUtil.convert24to12hourformat(message.getOriginalMessageTime()));
          if (message.getOriginalMessagePlaceholderImage() == null) {
            postMessageSentViewHolder.ismSentMessagePostBinding.vParentMessage.ivMessageImage.setVisibility(
                    View.GONE);
          } else {
            try {
              Glide.with(mContext)
                      ...
                      .diskCacheStrategy(DiskCacheStrategy.NONE)
                      .into(
                              postMessageSentViewHolder.ismSentMessagePostBinding.vParentMessage.ivMessageImage);
            } catch (IllegalArgumentException | NullPointerException ignore) {
            }
            postMessageSentViewHolder.ismSentMessagePostBinding.vParentMessage.ivMessageImage.setVisibility(
                    View.VISIBLE);
          }
          postMessageSentViewHolder.ismSentMessagePostBinding.vParentMessage.getRoot().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
              scrollToMessageListener.onScrollToParentMessage(message.getParentMessageId());
            }
        ...
        if (message.hasReactions()) {
          if (multipleMessagesSelectModeOn) {
            postMessageSentViewHolder.ismSentMessagePostBinding.rvMessageReactions.setVisibility(
                    View.GONE);
          } else {
            postMessageSentViewHolder.ismSentMessagePostBinding.rvMessageReactions.setLayoutManager(
                    new LinearLayoutManager(mContext, RecyclerView.HORIZONTAL, false));
            postMessageSentViewHolder.ismSentMessagePostBinding.rvMessageReactions.setAdapter(
                    new MessageReactionsAdapter(mContext, message.getReactions(),
                            message.getMessageId(), reactionClickListener));
            postMessageSentViewHolder.ismSentMessagePostBinding.rvMessageReactions.setVisibility(
                    View.VISIBLE);
        ...
        postMessageSentViewHolder.ismSentMessagePostBinding.tvMessageTime.setText(
                TimeUtil.convert24to12hourformat(message.getMessageTime()));

        if (message.isUploaded()) {

          postMessageSentViewHolder.ismSentMessagePostBinding.rlUpload.setVisibility(View.GONE);
          ...
          if (message.isDownloaded() || message.isDownloading()) {
            try {
              Glide.with(mContext)
                      ...
                      .placeholder(R.drawable.ism_avatar_group_large)
                      .transform(new CenterCrop())
                      .into(postMessageSentViewHolder.ismSentMessagePostBinding.ivPhoto);
            } catch (IllegalArgumentException | NullPointerException ignore) {
            }
          ...
          postMessageSentViewHolder.ismSentMessagePostBinding.rlUpload.setOnClickListener(v -> {
            if (message.isUploading()) {
              conversationMessagesActivity.cancelMediaUpload(message, position);
            } else {
              conversationMessagesActivity.removeCanceledMessage(message.getLocalMessageId(),
          ...
          postMessageSentViewHolder.ismSentMessagePostBinding.rlUpload.setVisibility(
                  View.VISIBLE);
        }

        postMessageSentViewHolder.ismSentMessagePostBinding.rlPhoto.setOnClickListener(view -> {
          IsometrikChatSdk.getInstance().getChatActionsClickListener().onSharedPostClick(message.getMessageId());
        });
      }
    } catch (Exception ignore) {
    }
    ...
    try {
      ...
      if (message != null) {
        ...
        if (message.isQuotedMessage()) {
          ...
          videoMessageSentViewHolder.ismSentMessageVideoBinding.vParentMessage.getRoot().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
              scrollToMessageListener.onScrollToParentMessage(message.getParentMessageId());
            }
    ...
    try {
      ...
      if (message != null) {
        ...
        if (message.isQuotedMessage()) {
          ...
          audioMessageSentViewHolder.ismSentMessageAudioBinding.vParentMessage.getRoot().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
              scrollToMessageListener.onScrollToParentMessage(message.getParentMessageId());
            }
    ...
    try {
      ...
      if (message != null) {
        ...
        if (message.isQuotedMessage()) {
          ...
          fileMessageSentViewHolder.ismSentMessageFileBinding.vParentMessage.getRoot().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
              scrollToMessageListener.onScrollToParentMessage(message.getParentMessageId());
            }
    ...
    try {
      ...
      if (message != null) {
        ...
        if (message.isQuotedMessage()) {
          ...
          stickerMessageSentViewHolder.ismSentMessageStickerBinding.vParentMessage.getRoot().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
              scrollToMessageListener.onScrollToParentMessage(message.getParentMessageId());
            }
    ...
    try {
      ...
      if (message != null) {
        ...
        if (message.isQuotedMessage()) {
          ...
          gifMessageSentViewHolder.ismSentMessageGifBinding.vParentMessage.getRoot().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
              scrollToMessageListener.onScrollToParentMessage(message.getParentMessageId());
            }
    ...
    try {
      ...
      if (message != null) {
        ...
        if (message.isQuotedMessage()) {
          ...
          contactMessageSentViewHolder.ismSentMessageContactBinding.vParentMessage.getRoot().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
              scrollToMessageListener.onScrollToParentMessage(message.getParentMessageId());
            }
      ...
      if (message != null) {
        ...
        if (message.isQuotedMessage()) {
          ...
          textMessageReceivedViewHolder.ismReceivedMessageTextBinding.vParentMessage.tvSenderName.setText(
                  message.getOriginalMessageSenderName());
          if(message.getOriginalMessage().equals("AttachmentMessage:Gif")) {
          ...
          if(message.getOriginalMessageTime() == null || message.getOriginalMessageTime().isEmpty()){
            textMessageReceivedViewHolder.ismReceivedMessageTextBinding.vParentMessage.tvMessageTime.setVisibility(View.GONE);
            textMessageReceivedViewHolder.ismReceivedMessageTextBinding.vParentMessage.tvComma.setVisibility(View.GONE);
          } else {
            textMessageReceivedViewHolder.ismReceivedMessageTextBinding.vParentMessage.tvMessageTime.setVisibility(View.VISIBLE);
          }
          textMessageReceivedViewHolder.ismReceivedMessageTextBinding.vParentMessage.ivMessageImage
                  .setVisibility(View.GONE);

          if (message.getOriginalMessageAttachmentUrl() != null && !message.getOriginalMessageAttachmentUrl().isEmpty()) {
            try {
              Glide.with(mContext)
                      .load(message.getOriginalMessageAttachmentUrl())
                      .diskCacheStrategy(DiskCacheStrategy.NONE)
            ...
            textMessageReceivedViewHolder.ismReceivedMessageTextBinding.vParentMessage.ivMessageImage
                    .setVisibility(View.VISIBLE);
            textMessageReceivedViewHolder.ismReceivedMessageTextBinding.vParentMessage.tvMessage.setVisibility(View.GONE);
          } else {
            textMessageReceivedViewHolder.ismReceivedMessageTextBinding.vParentMessage.tvMessage.setVisibility(View.VISIBLE);
          }
          textMessageReceivedViewHolder.ismReceivedMessageTextBinding.vParentMessage.getRoot()
                  .setOnClickListener(view -> scrollToMessageListener.onScrollToParentMessage(message.getParentMessageId()));
  ...
  private void configurePostMessageReceivedViewHolder(
          PostMessageReceivedViewHolder postMessageReceivedViewHolder, int position) {
    try {
      MessagesModel message = messages.get(position);
      if (message != null) {
        postMessageReceivedViewHolder.ismReceivedMessagePostBinding.ivEdited.setVisibility(
                message.isEditedMessage() ? View.VISIBLE : View.GONE);

        if (message.isForwardedMessage()) {
          postMessageReceivedViewHolder.ismReceivedMessagePostBinding.vForwardedMessage.getRoot()
                  .setVisibility(View.VISIBLE);

          if (message.getForwardedMessageNotes() == null) {

            postMessageReceivedViewHolder.ismReceivedMessagePostBinding.vForwardedMessageNotes.getRoot()
                    .setVisibility(View.GONE);
          } else {
            postMessageReceivedViewHolder.ismReceivedMessagePostBinding.vForwardedMessageNotes.tvMessage
                    .setText(message.getForwardedMessageNotes());
        ...
        if (multipleMessagesSelectModeOn) {
          ...
          postMessageReceivedViewHolder.ismReceivedMessagePostBinding.ivSelectedStatus.setSelected(
                  message.isSelected());
          postMessageReceivedViewHolder.ismReceivedMessagePostBinding.ivSelectedStatus.setVisibility(
                  View.VISIBLE);
          postMessageReceivedViewHolder.ismReceivedMessagePostBinding.ivReaction.setVisibility(
                  View.GONE);
        } else {
          postMessageReceivedViewHolder.ismReceivedMessagePostBinding.ivSelectedStatus.setVisibility(
                  View.GONE);
        ...
        if (message.isQuotedMessage()) {
          postMessageReceivedViewHolder.ismReceivedMessagePostBinding.vParentMessage.getRoot()
                  .setVisibility(View.VISIBLE);
          postMessageReceivedViewHolder.ismReceivedMessagePostBinding.vParentMessage.tvSenderName.setText(
                  message.getOriginalMessageSenderName());
          postMessageReceivedViewHolder.ismReceivedMessagePostBinding.vParentMessage.tvMessage.setText(
                  message.getOriginalMessage());
          postMessageReceivedViewHolder.ismReceivedMessagePostBinding.vParentMessage.tvMessageTime
                  .setText(message.getOriginalMessageTime());
          if (message.getOriginalMessagePlaceholderImage() == null) {
            postMessageReceivedViewHolder.ismReceivedMessagePostBinding.vParentMessage.ivMessageImage
                    .setVisibility(View.GONE);
          } else {
            try {
              Glide.with(mContext)
        ...
        if (message.hasReactions()) {
          if (multipleMessagesSelectModeOn) {
            postMessageReceivedViewHolder.ismReceivedMessagePostBinding.rvMessageReactions.setVisibility(
                    View.GONE);
          } else {
            postMessageReceivedViewHolder.ismReceivedMessagePostBinding.rvMessageReactions.setLayoutManager(
                    new LinearLayoutManager(mContext, RecyclerView.HORIZONTAL, false));
            postMessageReceivedViewHolder.ismReceivedMessagePostBinding.rvMessageReactions.setAdapter(
                    new MessageReactionsAdapter(mContext, message.getReactions(),
                            message.getMessageId(), reactionClickListener));
        ...
        if (message.isSenderDeleted()) {
          SpannableString spannableString = new SpannableString(message.getSenderName());
          spannableString.setSpan(new StyleSpan(Typeface.ITALIC), 0, spannableString.length(), 0);
          postMessageReceivedViewHolder.ismReceivedMessagePostBinding.tvSenderName.setText(
                  spannableString);
        } else {
          postMessageReceivedViewHolder.ismReceivedMessagePostBinding.tvSenderName.setText(
                  message.getSenderName());
        ...
        if (PlaceholderUtils.isValidImageUrl(message.getSenderImageUrl())) {
          ...
          try {
            Glide.with(mContext)
                    ...
                    .placeholder(R.drawable.ism_ic_profile)
                    .transform(new CircleCrop())
                    .into(postMessageReceivedViewHolder.ismReceivedMessagePostBinding.ivSenderImage);
          } catch (IllegalArgumentException | NullPointerException ignore) {
          }
        } else {
          PlaceholderUtils.setTextRoundDrawable(mContext, message.getSenderName(),
                  postMessageReceivedViewHolder.ismReceivedMessagePostBinding.ivSenderImage, position,
                  12);
        }
        ...
        try {
          Glide.with(mContext)
                  ...
                  .placeholder(R.drawable.ism_avatar_group_large)
                  .transform(new CenterCrop())
                  .into(postMessageReceivedViewHolder.ismReceivedMessagePostBinding.ivPhoto);
        } catch (IllegalArgumentException | NullPointerException ignore) {
        }

        postMessageReceivedViewHolder.ismReceivedMessagePostBinding.tvMessageTime.setText(
                TimeUtil.convert24to12hourformat(message.getMessageTime()));

        postMessageReceivedViewHolder.ismReceivedMessagePostBinding.ivReaction.setOnClickListener(
                v -> conversationMessagesActivity.addReactionForMessage(message.getMessageId()));
        if (joiningAsObserver) {
          postMessageReceivedViewHolder.ismReceivedMessagePostBinding.ivReaction.setVisibility(
                  View.GONE);
        }
        postMessageReceivedViewHolder.ismReceivedMessagePostBinding.rlPhoto.setOnClickListener(view -> {
          IsometrikChatSdk.getInstance().getChatActionsClickListener().onSharedPostClick(message.getMessageId());
        });
      }
    } catch (Exception ignore) {
    ...
    try {
      ...
      if (message != null) {
        ...
        if (message.isQuotedMessage()) {
          ...
          gifMessageReceivedViewHolder.ismReceivedMessageGifBinding.vParentMessage.getRoot().setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
              scrollToMessageListener.onScrollToParentMessage(message.getParentMessageId());
            }
  ...
  public int getPositionById(String parentMessageId) {
    for (int i = 0; i < messages.size(); i++) {
      if (messages.get(i).getMessageId().equals(parentMessageId)) {
        return i;
      }
    }
