...
import io.isometrik.chat.databinding.IsmSentMessageVideoCallBinding
import io.isometrik.ui.IsometrikChatSdk
import io.isometrik.ui.messages.action.MessageActionCallback
import io.isometrik.ui.messages.chat.MessagesModel
import io.isometrik.ui.messages.reaction.add.MessageReactionsAdapter

class VideoCallSentBinder : MessageItemBinder<MessagesModel, IsmSentMessageVideoCallBinding> {

    override fun createBinding(parent: ViewGroup, viewType: Int): IsmSentMessageVideoCallBinding {
        return IsmSentMessageVideoCallBinding.inflate(
    ...
    override fun bindData(
        mContext: Context,
        binding: IsmSentMessageVideoCallBinding,
