...
public enum MessageTypesForUI {
    ...
    OfferReceived(29),
    CounterOfferSent(30),
    CounterOfferReceived(31),
    EditOfferSent(32),
    EditOfferReceived(33),
    AcceptOfferSent(34),
    AcceptOfferReceived(35),
    CancelDealSent(36),
    CancelDealReceived(37),
    CancelOfferSent(38),
    CancelOfferReceived(39),
    BuyDirectSent(40),
    BuyDirectReceived(41),
    AcceptBuyDirectSent(42),
    AcceptBuyDirectReceived(43),
    CancelBuyDirectSent(44),
    CancelBuyDirectReceived(45),
    PaymentEscrowedSent(46),
    PaymentEscrowedReceived(47),
    DealCompleteSent(48),
    DealCompleteReceived(49);
