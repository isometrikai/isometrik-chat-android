...
public class Isometrik {
    ...
    public String getBaseUrl() {
        if (ChatConfig.INSTANCE.getBaseUrl() != null) {
            return ChatConfig.INSTANCE.getBaseUrl();
        } else {
    ...
    public String getConnectionBaseUrl() {
        if (ChatConfig.INSTANCE.getMqttConnectionUrl() != null) {
            return ChatConfig.INSTANCE.getMqttConnectionUrl();
        } else {
    ...
    public int getPort() {
        if (ChatConfig.INSTANCE.getMqttPort() != null) {
            return ChatConfig.INSTANCE.getMqttPort();
        } else {
