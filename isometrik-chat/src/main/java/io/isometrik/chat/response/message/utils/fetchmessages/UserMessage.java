...
/**
 * The helper class to parse the details of the user message.
 */
public class UserMessage {
   ...
   */
  public ArrayList<Member> getAddRemoveMembers() {
    return members;
  }
  ...
  /**
   * Gets private one to one.
   *
   * @return the private one to one
   */
