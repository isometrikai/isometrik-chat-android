...
/**
 * The helper class to parse the response of the fetch reactions request.
 */
public class FetchReactionsResult {
  @SerializedName("msg")
  @Expose
   ...
   * Gets user reactions.
   *
   * @return the user reactions
   */
  public ArrayList<UserReaction> getUserReactions() {
