...
/**
 * The query builder for uploading conversation image request.
 */
public class UploadConversationImageQuery {
  ...
  private UploadConversationImageQuery(Builder builder) {
  ...
  /**
   * The builder class for building upload conversation image query.
   */
  public static class Builder {
    ...
    /**
     * Build upload conversation image query.
     *
     * @return the upload conversation image query
     */
    public UploadConversationImageQuery build() {
      return new UploadConversationImageQuery(this);
    }
  }
