...
/**
 * The query builder for fetching mentioned messages request.
 */
public class FetchMentionedMessagesQuery {
  ...
  private FetchMentionedMessagesQuery(Builder builder) {
  ...
  /**
   * The builder class for building fetch mentioned messages query.
   */
  public static class Builder {
    ...
    /**
     * Build fetch mentioned messages query.
     *
     * @return the fetch mentioned messages query
     */
    public FetchMentionedMessagesQuery build() {
      return new FetchMentionedMessagesQuery(this);
    }
  }
