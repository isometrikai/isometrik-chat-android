...
/**
 * The helper class to validate request params and make the fetch unread conversations count request and expose the parsed successful or error response.
 */
public class FetchUnreadConversationsCount {
  /**
   * Validate params.
   *
  ...
  public void validateParams(
      ...
      @NotNull final CompletionHandler<FetchUnreadConversationsCountResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {

    String userToken = fetchUnreadConversationsCountQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<FetchUnreadConversationsCountResult> call = retrofitManager.getConversationService()
          .fetchUnreadConversationsCount(headers, queryParams);

      call.enqueue(new Callback<FetchUnreadConversationsCountResult>() {
        @Override
        public void onResponse(@NotNull Call<FetchUnreadConversationsCountResult> call,
            @NotNull Response<FetchUnreadConversationsCountResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<FetchUnreadConversationsCountResult> call,
            @NotNull Throwable t) {
