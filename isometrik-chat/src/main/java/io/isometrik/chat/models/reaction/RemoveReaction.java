...
/**
 * The helper class to validate request params and make the remove reaction request and expose the parsed successful or error response.
 */
public class RemoveReaction {
   ...
   * @param gson the gson
   */
  public void validateParams(@NotNull RemoveReactionQuery removeReactionQuery,
      @NotNull final CompletionHandler<RemoveReactionResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {
    String reactionType = removeReactionQuery.getReactionType();
    String conversationId = removeReactionQuery.getConversationId();
    String messageId = removeReactionQuery.getMessageId();
    String userToken = removeReactionQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      queryParams.put("reactionType", reactionType);
      queryParams.put("messageId", messageId);

      Call<RemoveReactionResult> call =
          retrofitManager.getReactionService().removeReaction(headers, reactionType, queryParams);

      call.enqueue(new Callback<RemoveReactionResult>() {
        @Override
        public void onResponse(@NotNull Call<RemoveReactionResult> call,
            @NotNull Response<RemoveReactionResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<RemoveReactionResult> call, @NotNull Throwable t) {
