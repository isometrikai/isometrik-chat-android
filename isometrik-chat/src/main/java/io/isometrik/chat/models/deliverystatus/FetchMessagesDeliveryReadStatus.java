...
/**
 * The helper class to validate request params and make the fetch messages delivery read status request and expose the parsed successful or error response.
 */
public class FetchMessagesDeliveryReadStatus {
  /**
   * Validate params.
   *
  ...
  public void validateParams(
      ...
      @NotNull final CompletionHandler<FetchMessagesDeliveryReadStatusResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {

    String conversationId = fetchMessagesDeliveryReadStatusQuery.getConversationId();
    List<String> messageIds = fetchMessagesDeliveryReadStatusQuery.getMessageIds();
    String userToken = fetchMessagesDeliveryReadStatusQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<FetchMessagesDeliveryReadStatusResult> call = retrofitManager.getDeliveryStatusService()
          .fetchMessagesDeliveryReadStatus(headers, queryParams);

      call.enqueue(new Callback<FetchMessagesDeliveryReadStatusResult>() {
        @Override
        public void onResponse(@NotNull Call<FetchMessagesDeliveryReadStatusResult> call,
            @NotNull Response<FetchMessagesDeliveryReadStatusResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<FetchMessagesDeliveryReadStatusResult> call,
            @NotNull Throwable t) {
