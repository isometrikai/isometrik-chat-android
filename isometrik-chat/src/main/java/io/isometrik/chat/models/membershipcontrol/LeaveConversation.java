...
/**
 * The helper class to validate request params and make the leave conversation request and expose the parsed successful or error response.
 */
public class LeaveConversation {
   ...
   * @param gson the gson
   */
  public void validateParams(@NotNull LeaveConversationQuery leaveConversationQuery,
      @NotNull final CompletionHandler<LeaveConversationResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {
    String conversationId = leaveConversationQuery.getConversationId();
    String userToken = leaveConversationQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<LeaveConversationResult> call =
          retrofitManager.getMembershipControlService().leaveConversation(headers, queryParams);

      call.enqueue(new Callback<LeaveConversationResult>() {
        @Override
        public void onResponse(@NotNull Call<LeaveConversationResult> call,
            @NotNull Response<LeaveConversationResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<LeaveConversationResult> call, @NotNull Throwable t) {
