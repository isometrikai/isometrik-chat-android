...
/**
 * The helper class to validate request params and make the fetch user details request and expose the parsed successful or error response.
 */
public class FetchUserDetails {
  ...
  public void validateParams(@NotNull FetchUserDetailsQuery fetchUserDetailsQuery,
    ...
    String userToken = fetchUserDetailsQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<FetchUserDetailsResult> call =
          retrofitManager.getUserService().fetchUserDetails(headers, queryParams);
