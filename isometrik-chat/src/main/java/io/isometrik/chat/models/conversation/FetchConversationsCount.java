...
/**
 * The helper class to validate request params and make the fetch conversations count request and expose the parsed successful or error response.
 */
public class FetchConversationsCount {
  /**
   * Validate params.
   *
   ...
   * @param gson the gson
   */
  public void validateParams(@NotNull FetchConversationsCountQuery fetchConversationsCountQuery,
      @NotNull final CompletionHandler<FetchConversationsCountResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {
    String userToken = fetchConversationsCountQuery.getUserToken();

    if (userToken == null || userToken.isEmpty()) {
      completionHandler.onComplete(null, IsometrikErrorBuilder.IMERROBJ_USER_TOKEN_MISSING);
    } else {
      List<String> membersIncluded = fetchConversationsCountQuery.getMembersIncluded();
      List<String> membersExactly = fetchConversationsCountQuery.getMembersExactly();
      List<String> conversationIds = fetchConversationsCountQuery.getConversationIds();
      String customType = fetchConversationsCountQuery.getCustomType();
      Integer conversationType = fetchConversationsCountQuery.getConversationType();
      Boolean isGroup = fetchConversationsCountQuery.getGroup();
      ...
      Call<FetchConversationsCountResult> call =
          retrofitManager.getConversationService().fetchConversationsCount(headers, queryParams);

      call.enqueue(new Callback<FetchConversationsCountResult>() {
        @Override
        public void onResponse(@NotNull Call<FetchConversationsCountResult> call,
            @NotNull Response<FetchConversationsCountResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<FetchConversationsCountResult> call,
            @NotNull Throwable t) {
