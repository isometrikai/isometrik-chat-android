...
/**
 * The helper class to validate request params and make the mark message as read request and expose the parsed successful or error response.
 */
public class MarkMessageAsRead {
   ...
   * @param gson the gson
   */
  public void validateParams(@NotNull MarkMessageAsReadQuery markMessageAsReadQuery,
      @NotNull final CompletionHandler<MarkMessageAsReadResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {
    String conversationId = markMessageAsReadQuery.getConversationId();
    String messageId = markMessageAsReadQuery.getMessageId();
    String userToken = markMessageAsReadQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<MarkMessageAsReadResult> call =
          retrofitManager.getMessageService().markMessageAsRead(headers, bodyParams);

      call.enqueue(new Callback<MarkMessageAsReadResult>() {
        @Override
        public void onResponse(@NotNull Call<MarkMessageAsReadResult> call,
            @NotNull Response<MarkMessageAsReadResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<MarkMessageAsReadResult> call, @NotNull Throwable t) {
