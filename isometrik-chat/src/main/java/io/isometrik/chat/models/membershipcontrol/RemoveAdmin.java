...
/**
 * The helper class to validate request params and make the remove admin request and expose the parsed successful or error response.
 */
public class RemoveAdmin {
   ...
   * @param gson the gson
   */
  public void validateParams(@NotNull RemoveAdminQuery removeAdminQuery,
      @NotNull final CompletionHandler<RemoveAdminResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {
    String conversationId = removeAdminQuery.getConversationId();
    String memberId = removeAdminQuery.getMemberId();
    String userToken = removeAdminQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<RemoveAdminResult> call =
          retrofitManager.getMembershipControlService().removeAdmin(headers, queryParams);

      call.enqueue(new Callback<RemoveAdminResult>() {
        @Override
        public void onResponse(@NotNull Call<RemoveAdminResult> call,
            @NotNull Response<RemoveAdminResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<RemoveAdminResult> call, @NotNull Throwable t) {
