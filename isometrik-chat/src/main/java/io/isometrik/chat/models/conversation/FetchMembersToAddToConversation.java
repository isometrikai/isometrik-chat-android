...
/**
 * The helper class to validate request params and make the fetch members to add to conversation request and expose the parsed successful or error response.
 */
public class FetchMembersToAddToConversation {
  /**
   * Validate params.
   *
  ...
  public void validateParams(
      ...
      @NotNull final CompletionHandler<FetchMembersToAddToConversationResult> completionHandler,
      @NotNull RetrofitManager retrofitManager, @NotNull IMConfiguration imConfiguration,
      @NotNull final BaseResponse baseResponse, final @NotNull Gson gson) {

    String conversationId = fetchMembersToAddToConversationQuery.getConversationId();
    Integer skip = fetchMembersToAddToConversationQuery.getSkip();
    Integer limit = fetchMembersToAddToConversationQuery.getLimit();
    Integer sort = fetchMembersToAddToConversationQuery.getSort();
    String searchTag = fetchMembersToAddToConversationQuery.getSearchTag();

    String userToken = fetchMembersToAddToConversationQuery.getUserToken();
    ...
    if (userToken == null || userToken.isEmpty()) {
      ...
      Call<FetchMembersToAddToConversationResult> call = retrofitManager.getConversationService()
          .fetchMembersToAddToConversation(headers, queryParams);

      call.enqueue(new Callback<FetchMembersToAddToConversationResult>() {
        @Override
        public void onResponse(@NotNull Call<FetchMembersToAddToConversationResult> call,
            @NotNull Response<FetchMembersToAddToConversationResult> response) {
        ...
        @Override
        public void onFailure(@NotNull Call<FetchMembersToAddToConversationResult> call,
            @NotNull Throwable t) {
