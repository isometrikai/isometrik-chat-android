...
public class IsometrikConnection {
  ...
  public void createConnection(@NotNull Isometrik isometrikInstance) {
    ...
    String username = imConfiguration.getUserName();
    String password = imConfiguration.getPassword();

    this.messagingTopic = "/" + accountId + "/" + projectId + "/Message/" + clientIdForTopicSubscribe;
    this.presenceEventsTopic = "/" + accountId + "/" + projectId + "/Status/" + clientIdForTopicSubscribe;
